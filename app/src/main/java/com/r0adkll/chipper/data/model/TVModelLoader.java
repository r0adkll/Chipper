 ...
 *            the generic type
 */
public class TVModelLoader<T extends Model> extends AsyncTaskLoader<List<T>>
{
	 ...
	 *            the clazz
	 */
	public TVModelLoader(Context context, Class<T> clazz)
	{
	 ...
	 */
	public TVModelLoader(Context context, Class<T> clazz, boolean updateOnRelationshipChanges){
	 ...
	 *            if true, loader will updated when tables related to the one detected are changed
	 */
	public TVModelLoader(Context context, Class<T> clazz, From from,
