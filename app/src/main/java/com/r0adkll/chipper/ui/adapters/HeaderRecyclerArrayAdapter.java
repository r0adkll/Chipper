...
public abstract class HeaderRecyclerArrayAdapter<M, VH extends RecyclerView.ViewHolder>
     ...
     * Default Constructor
     */
    public HeaderRecyclerArrayAdapter(View headerView) {
        setHasStableIds(true);
        mHeaderView = headerView;
    }

    public HeaderRecyclerArrayAdapter(){
        setHasStableIds(true);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        if(!(viewHolder instanceof HeaderViewHolder)){
            onBindItemViewHolder((VH) viewHolder, i-1);
        }
    }
    ...
    /**
     * Override this to provide the item view holder
     * @param viewGroup
     * @param i
     * @return
     */
     ...
     * @param i
     */
    public abstract void onBindItemViewHolder(VH holder, int i);
