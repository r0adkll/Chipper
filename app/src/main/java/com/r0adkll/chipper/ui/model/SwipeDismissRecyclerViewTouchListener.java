...
public class SwipeDismissRecyclerViewTouchListener implements View.OnTouchListener {
    ...
    public interface OnFrontViewClickListener{
        void onFrontViewClicked(int position);
    }
     ...
     */
    public SwipeDismissRecyclerViewTouchListener(RecyclerView listView, DismissCallbacks callbacks) {
    ...
    public void setOnFrontViewClickListener(OnFrontViewClickListener listener){
        mFrontViewClickListener = listener;
    }
        ...
        switch (motionEvent.getActionMasked()) {
            case MotionEvent.ACTION_DOWN: {
                ...
                if (mDownView != null) {
                    ...
                    mDownPosition = mListView.indexOfChild(mDownView);
                    ...
                    front.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if(mFrontViewClickListener != null){
                                mFrontViewClickListener.onFrontViewClicked(mDownPosition);
                            }
                        }
                    });
            ...
            case MotionEvent.ACTION_CANCEL: {
                ...
                if (mDownView != null && mSwiping) {
                    // cancel
                    View front = ButterKnife.findById(mDownView, R.id.front);
                    front.animate()
                         .translationX(0)
            ...
            case MotionEvent.ACTION_UP: {
                ...
                final View frontView = ButterKnife.findById(mDownView, R.id.front);
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mSwiping) {
                    View frontView = ButterKnife.findById(mDownView, R.id.front);
                    frontView.setTranslationX(deltaX - mSwipingSlop);
